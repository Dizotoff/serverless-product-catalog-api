...
```
curl --request POST 'https://xxxx.execute-api.us-east-1.amazonaws.com/users' --header 'Content-Type: application/json' --data-raw '{"name": "Kek", "userId": "someUserId2"}'
```
...
```
curl https://xxx.execute-api.us-east-1.amazonaws.com/users/someUserId
```
